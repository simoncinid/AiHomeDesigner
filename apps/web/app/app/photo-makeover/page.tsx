        ...
        <div className="h-full grid grid-cols-1 lg:grid-cols-2 gap-3">
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden flex flex-col min-h-0">
            <div className="flex-1 overflow-y-auto p-4 space-y-3">
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-900 mb-1.5">
                  Style Reference <span className="text-gray-400 font-normal">(Optional)</span>
                </label>
                <div
                  {...getStyleRootProps()}
                  className={`
                    border-2 border-dashed rounded-lg p-2 text-center cursor-pointer transition-all duration-200
                    ${isStyleDragActive 
                      ? 'border-sky-400 bg-sky-50' 
                      : styleRef
                        ? 'border-emerald-300 bg-emerald-50/50'
                ...
                >
                  ...
                  {styleRef ? (
                    ...
                    <div className="flex items-center justify-center gap-2 py-0.5">
                      ...
                      <span className="text-xs text-gray-500">Add style reference</span>
                    </div>
                  )}
                </div>
              </div>
              ...
              {baseImage ? (
                <div className="w-full h-full flex flex-col items-center justify-center space-y-3">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-gray-400 text-xs">Click "Generate Design" to see the magic</p>
                  </div>
                </div>
              ) : (
                <div className="text-center">
